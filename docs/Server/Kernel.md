...
!!! abstract "TF kernel"
    ...
    The code in
    [kernel](https://github.com/annotation/text-fabric/blob/master/tf/server/kernel.py)
...
!!! abstract "Connect"
    ...
    !!! example
        See the
        [web server](https://github.com/annotation/text-fabric/blob/master/tf/server/web.py)
        of the text-fabric browser.
