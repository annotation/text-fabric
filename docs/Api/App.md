...
???+ abstract "List of display parameters"
    See
    [INTERFACE_OPTIONS](../apidocs/html/tf/applib/displaysettings.html#tf.applib.displaysettings.INTERFACE_OPTIONS)
    and
    [DISPLAY_OPTIONS](../apidocs/html/tf/applib/displaysettings.html#tf.applib.displaysettings.DISPLAY_OPTIONS)
