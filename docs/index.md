...
??? abstract "Author and acknowledgements"
    **Author**:
    ...
    ???+ explanation "House cleaning"
        ...
        That was Text-Fabric version 1 at the end of 2016.

        It turned out that this has freed the way to work towards higher-level goals:
        supporting research data workflows.
        [Version 7](Use/Use7.md) capitalizes on that.
