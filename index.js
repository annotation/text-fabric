...
"url":30,
"doc":"Sends an informational message to the standard output. Parameters      msg: string The string to be displayed tm: boolean, optional  True Whether the message is to be prepended with the elapsed time. nl: boolean, optional  True Whether a newline should be appended to the message. cache: integer, optional  0 Whether the message should be cached.  ! caution \"Silence\" Informational messages are not displayed in silent mode.",
"func":1
},
{
"ref":"tf.core.timestamp.Timestamp.warning",
"url":30,
"doc":"Sends an warning message to the standard output. Parameters      msg: string The string to be displayed tm: boolean, optional  True Whether the message is to be prepended with the elapsed time. nl: boolean, optional  True Whether a newline should be appended to the message. cache: integer, optional  0 Whether the message should be cached.  ! caution \"Silence\" Warning messages are not displayed if silent mode is  deep .",
"func":1
},
{
...
"url":30,
"doc":"Changes the indentation and timing of forthcoming messages. Messages can be indented. Multiline messages will have the indent prepended to each of its lines. The reported time is with respect to a starting point, which can be reset. The starting points at different levels are independent of each other. level: integer, optional  None The indentation level. reset: boolean, optional  False If  True , the elapsed time to will be reset to 0 at the given level.",
"func":1
},
{
...
"url":84,
"doc":" Recorder Support for round trips of TF data to annotation tools and back. The scenario is:  Prepare a piece of corpus material for plain text use in an annotation tool, in this case BRAT.  Alongside the plain text, generate a mapping file that maps nodes to character positions in the plain text  Use BRAT to annotate the plain text  Read the resulting BRAT annotation files and convert them into TF features."
},
{
...
"ref":"tf.writing",
"url":86,
"doc":" Writing systems support Transliteration tables for various writing systems."
},
{
