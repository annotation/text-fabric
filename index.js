...
{
"ref":"tf.tools.myspacy.tokensAndSentences",
"url":23,
"doc":"Runs the Spacy NLP pipeline and delivers the results. Parameters      text: string The complete, raw text. lang: string, optional en The language to be used; its model should be installed; see  tf.tools.myspacy for how to get language models. Returns    - tuple  tokens : the token list as tuples  sentences : the sentence list as tuples Both tokens and sentences are tuples (start, end, text).",
"func":1
},
{
