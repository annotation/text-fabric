...
"url":19,
"doc":"Display markdown. Parameters      md: string Raw markdown string. inNb: boolean, optional True Whether the program runs in a notebook Returns    - None The formatted markdown is rendered in the output cell if  inNb else the raw markdown is printed to the output.",
"func":1
},
{
"ref":"tf.advanced.helpers.dh",
"url":19,
"doc":"Display HTML. Parameters      html: string Raw html string. inNb: boolean, optional True Whether the program runs in a notebook Returns    - None The formatted HTML is rendered in the output cell if  inNb else the raw HTML is printed to the output.",
"func":1
},
{
