...
"tf/browser/ner/kernel.html",
"tf/browser/ner/servelib.html",
"tf/browser/ner/serve.html",
"tf/browser/ner/tables.html",
"tf/browser/ner/wrap.html",
...
"url":96,
"doc":"Serves the NE annotation tool. Parameters      web: object The flask web app",
"func":1
},
{
"ref":"tf.browser.ner.tables",
"url":97,
"doc":"Module to compose tables of result data."
},
{
"ref":"tf.browser.ner.tables.composeE",
"url":97,
"doc":"Compose a table of entities with selection and sort controls. Parameters      app: object The TF app of the corpus in question. setData: dict The entity data of the chosen set. We only need the  entitiesByKind member. sortKey: string Indicates how to sort the table:   freqsort : by the frequency of the entities   kindsort : by the kind of the entities   etxtsort : by the text of the entities sortDir: string Indicates the direction of the sort:   u : up, i.e. ascending   d : down, i.e. descending Returns    - html string The finished HTML of the table, ready to put into the Flask template.",
"func":1
},
{
...
"url":97,
"doc":"HTML for the query tokens. Parameters      app: object The TF app of the corpus in question. tokenStart, tokenEnd: int or None Specify the start slot number and the end slot number of a sequence of tokens. Only sentences that contain this token sentence will be passed through, all other sentences will be filtered out. Returns    - html string The finished HTML of the query parameters",
"func":1
},
{
