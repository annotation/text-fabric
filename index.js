...
"url":96,
"doc":"Compose a table of entities with selection and sort controls. Parameters      app: object The TF app of the corpus in question. entities: dict The entities as already present in the dataset, usually the result of the NLP pipeline. sortKey: string Indicates how to sort the table:   freqsort : by the frequency of the entities   kindsort : by the kind of the entities   etxtsort : by the text of the entities sortDir: string Indicates the direction of the sort:   u : up, i.e. ascending   d : down, i.e. descending Returns    - html string The finished HTML of the table, ready to put into the Flask template.",
"func":1
},
{
...
"url":97,
"doc":"HTML for the kinds of entities. Parameters      kinds: tuple of tuples Frequency list of entity kinds Returns    - HTML string",
"func":1
},
{
