			...
			<div id="sidebarcont">
				...
				<div status="help">
					...
					<details id="helpExport" class="help">
						...
						<p>Export your results. Provide your name, title, and description (markdown is supported).</p>
						<p>Click <button type="button" class="fa fa-box-open"></button>.
						   The exported page opens in a new window or tab, formatted for saving as PDF.<br/>
						...
						<p>Click <button type="button" class="fa fa-download"></button>.
						   Additional data will be exported as files in a subdirectory corresponding to the current job:<br/>
						   ...
						   (4) a file <code>job.json</code> with the job information. You can import this in the job section to restore 
							 your job, or send it to a colleague who can then run the same query.</p>
