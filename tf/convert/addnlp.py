...
class NLPipeline:
    def __init__(
        ...
        self.removeSlotFeatures = removeSlotFeatures
        self.emptyFeature = emptyFeature
        self.ignoreTypes = ignoreTypes
        self.outOfFlow = outOfFlow
        self.sentenceSkipFlow = sentenceSkipFlow
        self.tokenType = tokenType
        self.tokenFeatures = tokenFeatures
        self.tokenNFeature = tokenNFeature
        self.sentenceType = sentenceType
        self.sentenceFeatures = sentenceFeatures
        self.sentenceNFeature = sentenceNFeature
        self.verbose = -1
